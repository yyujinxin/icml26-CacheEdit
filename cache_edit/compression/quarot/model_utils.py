...
def replace_modules(
    ...
    for name, module in root.named_children():
        new_module = None
        if isinstance(module, type_to_replace) and not name in block_list:
            ...
            replace_modules(module, type_to_replace, new_module_factory, replace_layers, block_list)
